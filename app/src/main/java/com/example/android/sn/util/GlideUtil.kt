package com.example.android.sn.util
...
object GlideUtil {
     ...
     * 默认图片
     */
    fun loadPicture(imageView: ImageView, url: Any, @DrawableRes defaultDrawableRes: Int) {
     ...
     * 图片地址
     */
    fun loadPicture(imageView: ImageView, url: Any) {
        try {
            Glide.with(imageView.context)
                    .load(url)
                    .listener(object : RequestListener<Drawable> {
